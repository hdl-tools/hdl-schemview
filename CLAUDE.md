...
| `app/src/api.ts` | Typed wrappers over Tauri `invoke()`. `traceGraph` (#244 PR2) is the trace-mode query; like `cone` before it, it is **unconsumed frontend surface until PR3** wires the Hierarchy \| Trace toggle. |
