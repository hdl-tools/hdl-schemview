...
bash core/scripts/scale-bench-collect.sh [--full] [--model <hierarchy.json>] [--online] \
    [--bases "golden 665"] [--skip-criterion]
...
- **Roadmap** — Phase 0–2 = model/matcher/cross-probe; Phase 3 = schematic + Tauri app
  ...
  producing a paste-ready metrics file. See also `docs/ROADMAP.md`.
